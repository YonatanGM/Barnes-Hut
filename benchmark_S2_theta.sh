...
benchmark_dir="benchmark_S2_${SLURM_JOB_ID}/${sanitized_file}_dt_${dt}_tend_${t_end}_vs_${vs}_theta_${theta}"
...
# Parameter Ranges
body_counts=(1000 10000 25000 50000 100000 200000 300000)
node_counts=(1 2 3 4)
thread_counts=(1 2 4 8 12 24 48 96)
theta_values=(0.1 0.2 0.3 0.5 0.7 1.0 1.2 1.5 1.7 2.0)
