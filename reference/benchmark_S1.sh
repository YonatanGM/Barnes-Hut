...
#SBATCH --output=benchmark_S1.out
#SBATCH --error=benchmark_S1.err
...
set -x
# Default Parameters
file=${1:-"../data/state_vectors_csvs/scenario1_19054.csv"}
dt=${2:-"1h"}
t_end=${3:-"10d"}
vs=${4:-"12h"}
theta=${5:-"1.05"}
...
# unique per sbatch submission
benchmark_dir="benchmark_S1_${SLURM_JOB_ID}/${sanitized_file}_dt_${dt}_tend_${t_end}_vs_${vs}_theta_${theta}"
...
# Parameter Ranges
body_counts=(100 1000 5000 10000 15000 19000)
node_counts=(1 2 3 4)
...
fixed_threads=48
fixed_theta=1.05
fixed_bodies=19050 # Adjust as needed
